...
-> Args({1, 1, 500, 100, 1}) 
-> Args({1, 1, 100, 500, 1}) 
-> Args({1, 1, 1000, 1000, 1}) 
-> Args({1, 1, 500, 5000, 1}) 
-> Args({1, 10, 1000, 1000, 1}) 
-> Args({1, 10, 500, 5000, 1})
-> Args({1, 1, 100, 100, 5}) 
-> Args({1, 1, 500, 100, 5}) 
-> Args({1, 1, 100, 500, 5}) 
-> Args({1, 1, 1000, 1000, 5}) 
-> Args({1, 1, 500, 5000, 5}) 
-> Args({1, 10, 1000, 1000, 5}) 
-> Args({1, 10, 500, 5000,5})
-> Args({1, 1, 100, 100, 10}) 
-> Args({1, 1, 500, 100, 10}) 
-> Args({1, 1, 100, 500, 10}) 
-> Args({1, 1, 1000, 1000, 10}) 
-> Args({1, 1, 500, 5000, 10}) 
-> Args({1, 10, 1000, 1000, 10}) 
-> Args({1, 10, 500, 5000, 10})
-> UseManualTime();
