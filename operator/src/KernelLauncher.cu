...
template <typename... Args>
void KernelLauncher<Args...>::run_fwd(const complex_vector* __restrict__ model, complex_vector* __restrict__ data, Args... args) {
...
template <typename... Args>
void KernelLauncher<Args...>::run_adj(complex_vector* __restrict__ model, const complex_vector* __restrict__ data, Args... args) {
