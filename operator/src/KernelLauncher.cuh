...
public:
  ...
  void run_adj(complex_vector* __restrict__ model, const complex_vector* __restrict__ data, Args... args);

  dim3 _grid_, _block_;
  void (*_fwd_kernel_)(const complex_vector* __restrict__, complex_vector* __restrict__, Args...);
  void (*_adj_kernel_)(complex_vector* __restrict__, const complex_vector* __restrict__, Args...);
